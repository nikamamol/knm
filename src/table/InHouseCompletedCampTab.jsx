...
function InHouseCompletedCampTab() {
    ...
    const activeCampaigns = campaigns.filter((campaign) => campaign.campaignStatus === 'Completed');
...
export default InHouseCompletedCampTab
